...
public class CustomPathResourceResolver  extends AbstractResourceResolver {
    ...
    protected Resource resolveResourceInternal(@Nullable HttpServletRequest request, String requestPath,
        ...
        logger.info("resolve Url pattern : "+request);
    ...
    protected String resolveUrlPathInternal(String resourcePath, List<? extends Resource> locations,
        ...
        logger.info("resolve Url pattern : "+resourcePath);
